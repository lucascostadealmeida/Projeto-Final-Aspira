let numAlt = document.querySelector<HTMLInputElement>('#alt')!
let numPeso = document.querySelector<HTMLInputElement>('#peso')!
...
const mensagem2 = document.querySelector<HTMLParagraphElement>('#mensagem2')!
...
formulario.addEventListener('submit', (e: Event) => {
    ...
    function calcIMC(num1: number, num2: number) {
        if (isNaN(num1)) {
